    ...
    public function run(): void
    {
        ...
        DB::table('store_settings')->updateOrInsert(
            ...
            [
                ...
                'google_tag_manager_id' => env('STORE_GOOGLE_TAG_MANAGER_ID'),
                'facebook_pixel_id' => env('STORE_FACEBOOK_PIXEL_ID'),
                'show_topbar' => true,
                ...
                'country' => 'India',
                'invoice_prefix' => 'LD',
                'footer_copyright_text' => '© 2026 Tadpole Story LLP. All rights reserved',
