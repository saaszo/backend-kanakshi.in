...
<div class="dashboard-shell">
    <div class="page-head">
        <div>
            ...
            <p class="page-subtitle">{{ $auction->title }}</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.auctions.update', $auction) }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="url" class="form-control @error('image_url') is-invalid @enderror"
                           id="image_url" name="image_url" value="{{ old('image_url', $auction->image_url) }}" placeholder="https://...">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" min="0" class="form-control @error('start_price') is-invalid @enderror"
                           id="start_price" name="start_price" value="{{ old('start_price', $auction->start_price) }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" min="0" class="form-control @error('reserve_price') is-invalid @enderror"
                           id="reserve_price" name="reserve_price" value="{{ old('reserve_price', $auction->reserve_price) }}" placeholder="Optional">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" min="1" class="form-control @error('min_bid_increment') is-invalid @enderror"
                           id="min_bid_increment" name="min_bid_increment" value="{{ old('min_bid_increment', $auction->min_bid_increment) }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="datetime-local" class="form-control @error('start_at') is-invalid @enderror"
                           ...
                           value="{{ old('start_at', $auction->start_at?->format('Y-m-d\TH:i')) }}" required>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror"
                              id="description" name="description" rows="4">{{ old('description', $auction->description) }}</textarea>
            ...
            <div class="mt-4 d-flex gap-2">
                <button type="submit" class="button">
                    <i class="bi bi-check-lg"></i> Update Auction
                </button>
